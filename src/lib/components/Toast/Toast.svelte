        ...
        >
            <div class="left">
                <div class="toast-icon">
                    ...
                    {/if}
                    {#if toast.type === 'error'}
                        <svg width="24" height="24" viewBox="0 0 384 384" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path
                    ...
                    {#if toast.type === 'warning'}
                        <svg width="24" height="21" viewBox="0 0 24 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12 0L0 20.8H24L12 0ZM12 3.2016L21.2296 19.2H2.7704L12 3.2016Z" fill="white" />
